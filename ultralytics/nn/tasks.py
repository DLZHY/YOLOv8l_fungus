...
from ultralytics.nn.ECA import ECAAttention
from ultralytics.nn.PolarizedSelfAttention import ParallelPolarizedSelfAttention
from ultralytics.nn.GE import GatherExcite
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        elif m in {MHSA, SEAttention, ECAAttention, ParallelPolarizedSelfAttention, GatherExcite}:
            args = [ch[f], *args]
